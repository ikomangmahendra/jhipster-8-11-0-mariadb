...
export class TagUpdateComponent implements OnInit {
  ...
  protected updateForm(tag: ITag): void {
    ...
    this.postsSharedCollection = this.postService.addPostToCollectionIfMissing<IPost>(this.postsSharedCollection, ...(tag.entries ?? []));
  }
  ...
  protected loadRelationshipsOptions(): void {
    this.postService
      ...
      .pipe(map((posts: IPost[]) => this.postService.addPostToCollectionIfMissing<IPost>(posts, ...(this.tag?.entries ?? []))))
